...
class ApplicationTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ibrows_boxalino.client.http_p13n_service' => 'getIbrowsBoxalino_Client_HttpP13nServiceService',
            'ibrows_boxalino.exporter.exporter' => 'getIbrowsBoxalino_Exporter_ExporterService',
            'ibrows_boxalino.twig.twig_extension' => 'getIbrowsBoxalino_Twig_TwigExtensionService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => (__DIR__.'/symfony.db'), 'host' => 'localhost', 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'memory' => true, 'port' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/Entity'))), 'Ibrows\\BoxalinoBundle\\Tests\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('test_entities' => 'Ibrows\\BoxalinoBundle\\Tests\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e9652989c6640b79a22e714a92c8da7bc44c3a9c6f5a6e26dc19ea0bd4eea6d8');
    ...
    /**
     * Gets the 'ibrows_boxalino.client.http_p13n_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ibrows\BoxalinoBundle\Helper\HttpP13nService A Ibrows\BoxalinoBundle\Helper\HttpP13nService instance.
     */
    protected function getIbrowsBoxalino_Client_HttpP13nServiceService()
    {
        return $this->services['ibrows_boxalino.client.http_p13n_service'] = new \Ibrows\BoxalinoBundle\Helper\HttpP13nService('cdn.bx-cloud.com', 'test', 'test', 'test', 'test.dev');
    }

    /**
     * Gets the 'ibrows_boxalino.exporter.exporter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ibrows\BoxalinoBundle\Exporter\Exporter A Ibrows\BoxalinoBundle\Exporter\Exporter instance.
     */
    protected function getIbrowsBoxalino_Exporter_ExporterService()
    {
        return $this->services['ibrows_boxalino.exporter.exporter'] = new \Ibrows\BoxalinoBundle\Exporter\Exporter($this->get('doctrine.orm.default_entity_manager'), array('product' => array('class' => 'Ibrows\\BoxalinoBundle\\Tests\\Entity\\Product', 'fields' => array(0 => 'id', 1 => 'name', 2 => 'description', 3 => 'brand')), 'brand' => array('class' => 'Ibrows\\BoxalinoBundle\\Tests\\Entity\\Brand', 'fields' => array(0 => 'id', 1 => 'name', 2 => 'products')), 'productCategory' => array('class' => 'Ibrows\\BoxalinoBundle\\Tests\\Entity\\ProductCategory', 'fields' => array(0 => 'id', 1 => 'name', 2 => 'products'))), 'http://di1.bx-cloud.com', (__DIR__.'/'), 'test', 'test', 'test', true);
    }

    /**
     * Gets the 'ibrows_boxalino.twig.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ibrows\BoxalinoBundle\Twig\TwigExtension A Ibrows\BoxalinoBundle\Twig\TwigExtension instance.
     */
    protected function getIbrowsBoxalino_Twig_TwigExtensionService()
    {
        $this->services['ibrows_boxalino.twig.twig_extension'] = $instance = new \Ibrows\BoxalinoBundle\Twig\TwigExtension();

        $instance->setAcccount('test');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Th1sTokenIsProbablyM0reS3cret,ButYouShouldCh4ng€ItAnyway!');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IbrowsBoxalinoBundle' => 'Ibrows\\BoxalinoBundle\\IbrowsBoxalinoBundle',
            ),
            ...
            'secret' => 'Th1sTokenIsProbablyM0reS3cret,ButYouShouldCh4ng€ItAnyway!',
            'swiftmailer_dev_deliveryaddress' => 'firstname.lastname@ibrows.ch',
            'airbrake_api_disabled' => 'true',
            'deploy_server' => 'localhost',
            'deploy_environment' => 'dev',
            'translation_helper_create' => false,
            'translation_helper_decorate' => '%s',
            ...
            'kernel.secret' => 'Th1sTokenIsProbablyM0reS3cret,ButYouShouldCh4ng€ItAnyway!',
            ...
            'debug.container.dump' => (__DIR__.'/ApplicationTestDebugProjectContainer.xml'),
            ...
            'ibrows_boxalino.debug_mode' => true,
            'ibrows_boxalino.account' => 'test',
            'ibrows_boxalino.username' => 'test',
            'ibrows_boxalino.password' => 'test',
            'ibrows_boxalino.cookie_domain' => 'test.dev',
            'ibrows_boxalino.host' => 'cdn.bx-cloud.com',
            'ibrows_boxalino.export_directory' => (__DIR__.'/'),
            'ibrows_boxalino.export_server' => 'http://di1.bx-cloud.com',
            'ibrows_boxalino.entities' => array(
                'product' => array(
